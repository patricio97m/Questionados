...
INSERT INTO Pregunta (pregunta, idCategoria, dificultad, fecha_pregunta, idUsuario, esVerificada) VALUES
                                               ('¿Cuál es la capital de Francia?', 1 , 'facil', DATE_SUB(NOW(), INTERVAL 7 DAY), 1, true),
                                               ('¿Quién escribió Romeo y Julieta?', 5, 'medio', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿Cuál es el símbolo químico del oxígeno?', 2, 'facil', DATE_SUB(NOW(), INTERVAL 7 DAY), 1, true),
                                               ('¿Cuál es el deporte más popular en Brasil?', 6, 'facil', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿Quién es el actor principal de la película "Titanic"?', 4, 'medio', DATE_SUB(NOW(), INTERVAL 1 DAY), 1, true),
                                               ('¿En qué año comenzó la Primera Guerra Mundial?', 3, 'dificil', DATE_SUB(NOW(), INTERVAL 1 DAY), 1, true),
                                               ('¿Cuál es el río más largo del mundo?', 1, 'dificil', DATE_SUB(NOW(), INTERVAL 1 DAY), 1, true),
                                               ('¿En qué año se firmó la Declaración de Independencia de los Estados Unidos?', 3, 'dificil', DATE_SUB(NOW(), INTERVAL 1 DAY), 1, true),
                                               ('¿Quién pintó la Mona Lisa?', 5, 'medio', NOW(), 1, true),
                                               ('¿Cuál es el planeta más cercano al Sol?', 2, 'dificil', NOW(), 1, true),
                                               ('¿Quién ganó el Mundial de Fútbol en 2022?', 6, 'facil', DATE_SUB(NOW(), INTERVAL 7 DAY), 1, true),
                                               ...
                                               ('¿Cuál es el elemento más abundante en la corteza terrestre?', 2, 'medio', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿Cuál es el país más poblado del mundo?', 1, 'dificil', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿Quién escribió Don Quijote de la Mancha?', 5, 'dificil', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿Cuál es el deporte que se juega en el Super Bowl?', 6, 'medio', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿En qué año se fundó Google?', 2, 'medio', DATE_SUB(NOW(), INTERVAL 7 DAY), 1, true),
                                               ('¿Cuál es el río que atraviesa El Cairo?', 1, 'facil', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿Cuál es la capital de Noruega?', 1, 'dificil', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿Quién pintó La Noche Estrellada?', 5, 'dificil', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿Cuál es la capital de Japón?', 1, 'facil', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿Cuál es el país conocido como la Tierra del Sol Naciente?', 1, 'facil', NOW(), 1, true),
                                               ('¿Quién escribió Hamlet?', 5, 'dificil', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿Cuál es el país donde se originó el tango?', 5, 'medio', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿Cuál es el deporte que se juega en Wimbledon?', 6, 'facil', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true),
                                               ('¿En qué año se estrenó la película Star Wars: Episodio IV - Una Nueva Esperanza?', 4, 'dificil', DATE_SUB(NOW(), INTERVAL 30 DAY), 1, true);
